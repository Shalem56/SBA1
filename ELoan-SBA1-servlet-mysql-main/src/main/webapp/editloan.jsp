...
<jsp:include page="header.jsp" />
	...
	<div align="center">
		<div>
			<label for="Application Number" style="font-size: 31px; font-weight: bold;">Enter your application number</label><br>
		</div>
		<div>
	...
	<% } 
		...
		%>
		<%} else { %>
		<div align="center"><h2>Loan edit unsuccessful !!!</h2></div>
		<% 	}
		request.removeAttribute("editStatus");	
		%>
				
		<div align="center"><h2>Loan edit successful !!!</h2></div>
		<table id="loanInfo">
		<thead>
			<tr>
				<th>User Name</th>
